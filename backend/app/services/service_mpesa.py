...
class MpesaService:
    ...
    def get_service_price(self, service_id: str) -> float:
        ...
        try:
            ...
            response = db.table('service_prices') \
                .select('price') \
    ...
    def save_payment_record(self, user_id: str, service_id: str, amount: float, 
        ...
        try:
            ...
            response = db.table('payments').insert(data).execute()
    ...
    def unlock_service(self, user_id: str, service_id: str, payment_ref: str) -> bool:
        ...
        try:
            ...
            existing = db.table('service_access') \
                .select('id') \
                .eq('user_id', user_id) \
            ...
            response = db.table('service_access').insert(data).execute()
    ...
    def initiate_stk_push(self, phone: str, amount: float, 
        ...
        Args:
            ...
            account_reference: Service ID (mileage, valuation, etc.)
    ...
    def get_user_services(self, user_id: str) -> List[Dict[str, Any]]:
        ...
        """
        try:
            response = db.table('service_access') \
                .select('*') \
                .eq('user_id', user_id) \
                .eq('status', 'active') \
                .execute()
    ...
    def get_all_services(self) -> List[Dict[str, Any]]:
        ...
        for service_id, price in self.service_prices.items():
            # Try to get updated price from database
            try:
