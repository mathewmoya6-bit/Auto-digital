...
# ================================================================
# TYPE: MODULE - Cheki specific scraper
...
class ChekiScraper(BaseScraper):
    ...
    async def _parse_listing(self, url: str) -> Dict[str, Any]:
        """
        Parse a single Cheki listing page.
        ...
        try:
            ...
            price_elem = soup.select_one("span.listing-price")
            ...
            # Extract image
            image_elem = soup.select_one("img.listing-image")
