...
def setup_middleware(app: FastAPI) -> None:
    ...
    ends up as the OUTERMOST middleware layer. In Starlette, the last
    middleware registered wraps everything else — including whatever
    is added in this function — which lets CORSMiddleware attach
    Access-Control-* headers even to responses/errors produced by the
    middleware below (e.g. TrustedHostMiddleware rejections), and to
