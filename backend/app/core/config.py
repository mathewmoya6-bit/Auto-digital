...
def create_supabase_client() -> Client:
    """
    Create the backend Supabase client.

    The backend uses the Service Role key so trusted server-side
    operations (payments, callbacks, service activation, etc.)
    ...
    logger.info("Creating Supabase Service Role client.")
